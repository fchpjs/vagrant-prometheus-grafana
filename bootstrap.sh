...
# Extract files
tar -xvzf /home/vagrant/Downloads/prometheus-2.38.0.linux-amd64.tar.gz
...
wget https://github.com/prometheus/node_exporter/releases/download/v1.3.1/node_exporter-1.3.1.linux-amd64.tar.gz -O /home/vagrant/Downloads/node_exporter-1.3.1.linux-amd64.tar.gz

# extract node_exporter
tar -xvzf /home/vagrant/Downloads/node_exporter-1.3.1.linux-amd64.tar.gz

# create a symbolic link of node_exporter
sudo ln -s /home/vagrant/Prometheus/node_exporter/node_exporter-1.3.1.linux-amd64/node_exporter /usr/bin
...
cd /home/vagrant/Prometheus/server/prometheus-2.38.0.linux-amd64/
...
# download grafana
wget https://dl.grafana.com/oss/release/grafana_9.1.3_amd64.deb -O /home/vagrant/Downloads/grafana_9.1.3_amd64.deb

sudo apt-get install -y adduser libfontconfig

# install grafana 
sudo dpkg -i /home/vagrant/Downloads/grafana_9.1.3_amd64.deb
